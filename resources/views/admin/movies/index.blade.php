...
@section('content')
<div class="container mx-auto px-6 py-8" data-content-type="movie">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-4">
            <button id="refresh-all-tmdb-btn" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold transition" title="Refresh TMDB data for ALL movies">
                <i class="fas fa-sync-alt"></i> Refresh All TMDB
            </button>
            <a href="{{ route('admin.tmdb-new.index') }}" class="bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-lg font-semibold transition">
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-gray-700">
                    <td class="bulk-checkbox-column">
                        <input type="checkbox" class="bulk-checkbox" value="{{ $movie->id }}" title="Select movie">
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <img src="{{ $movie->poster_url }}" alt="{{ $movie->title }}" class="w-12 h-16 rounded mr-4">
                            <div>
                ...
                @empty
                <tr>
                    <td colspan="7" class="px-6 py-4 text-center text-gray-400">No movies found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<script src="{{ asset('js/admin/refresh_all_tmdb_movies_admin_panel.js') }}?v={{ filemtime(public_path('js/admin/refresh_all_tmdb_movies_admin_panel.js')) }}" defer></script>
@endsection