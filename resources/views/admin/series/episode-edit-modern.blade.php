...
<div class="container mx-auto px-6 py-8 max-w-4xl">
    ...
    <form id="episode-edit-form"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- Download URL --}}
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-400 mb-2">Download URL (Optional)</label>
                <input type="url"
                       name="download_url"
                       id="download_url"
                       class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400"
            ...
            {{-- Thumbnail URL --}}
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-400 mb-2">Episode Thumbnail URL (Optional)</label>
                <input type="url" 
                       name="still_path" 
                       id="still_path" 
                       class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400" 
