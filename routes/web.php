...
Route::middleware('guest')->group(function () {
    ...
    // SECURITY: Invite Code Validation - Rate Limited to prevent brute force
    Route::post('/auth/validate-invite-code', [RegisterController::class, 'checkInviteCode'])
...
Route::middleware(['auth', 'admin', CheckPermission::class . ':access_admin_panel', 'throttle:60,1', 'password.rehash', 'audit'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('bulk')->name('bulk.')->group(function () {
        ...
        Route::post('/refresh-all-tmdb', [\App\Http\Controllers\Admin\BulkOperationController::class, 'refreshAllTMDB'])->name('refresh-all-tmdb');
